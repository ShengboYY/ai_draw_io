...
具体 domain-version adapters/materialization backend、Pre-Planner/route dispatcher 的 production executor wiring 与 production V2 assignment 仍待后续 M2 切片；production assignment 继续全部 legacy。
