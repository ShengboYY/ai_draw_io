...
# Release identity is intentionally immutable because MySQL DDL is not fully transactional.
MIGRATION_RELEASE="20260722"
MIGRATION_ROOT="/migration"
MIGRATION_MANIFEST="${MIGRATION_ROOT}/release-20260722.manifest"
EXPECTED_MIGRATION_COUNT="5"
PREDECESSOR_RELEASE="20260717"
PREDECESSOR_MANIFEST="${MIGRATION_ROOT}/release-20260717.manifest"
EXPECTED_PREDECESSOR_COUNT="30"
