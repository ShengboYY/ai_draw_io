...
public class SecurityConfig {
    ...
    /**
     * CORS with credentials so the SPA can send its session cookie. {@code allowedOriginPatterns}
     * with {@code *} is required (allowCredentials=true forbids the plain {@code "*"} origin).
     */
    @Bean
