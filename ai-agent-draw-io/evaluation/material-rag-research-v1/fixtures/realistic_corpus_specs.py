...
ADDITIONAL_MULTI_CASES = [
    {
        ...
        "expectedPages": [2, 3],
        "expectedAnswer": "6.8 ML/d before, 5.1 ML/d after, a decrease of 1.7 ML/d or 25.0%.",
    ...
    },
    {
        ...
        "expectedPages": [2, 3],
        "expectedAnswer": "Wait 7 minutes before removing the cover; use 6.2 N m for the DC terminal.",
    ...
    },
    {
        ...
        "groupId": "before_after",
        "expectedPages": [2, 3],
        "expectedAnswer": "5.6 degrees C at baseline and 4.8 degrees C with the revised liner, a 0.8 degree C or 14.3% reduction.",
    ...
    },
    {
        ...
        "groupId": "before_after",
        "expectedPages": [2, 3],
        "expectedAnswer": "41.2% at baseline and 55.7% after two seasons, an absolute increase of 14.5 percentage points.",
    ...
    },
    {
        ...
        "expectedPages": [2, 3],
        "expectedAnswer": "A2 has a 38 mm high-priority edge split; the cumulative visible-light limit is 12,000 lux-hours.",
