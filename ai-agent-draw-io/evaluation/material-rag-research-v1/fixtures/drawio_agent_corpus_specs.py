...
DRAWIO_FACTS = [
    ...
    {"anchorId": "dwh-factual-edit", "source": "drawio-workflow-handbook", "version": "v1", "page": 5, "modality": "text", "goldMatch": "必须重新检查证据", "queries": ["修改节点数值后需要做什么？", "What is required after changing a factual node value?"]},
    ...
    {"anchorId": "dcg-editor-approve", "source": "drawio-collaboration-governance", "version": "v1", "page": 2, "modality": "table", "primaryCategory": "versionAndAuthorization", "evaluationContext": {"scenarioType": "authorizationScope", "actingRole": "Editor", "scopeConstraint": "attempt to approve a chartbook release", "expectedDecision": "deny release approval"}, "goldMatch": "Editor may edit the canvas but cannot approve a release", "queries": ["Can an Editor approve a release?", "Editor 能否批准发布？"]},
    ...
    {"anchorId": "dcg-removed", "source": "drawio-collaboration-governance", "version": "v1", "page": 3, "modality": "text", "primaryCategory": "versionAndAuthorization", "evaluationContext": {"scenarioType": "authorizationScope", "actingRole": "chartbook member", "scopeConstraint": "the material share was removed before a new request", "expectedDecision": "block new retrieval immediately"}, "goldMatch": "blocks new retrieval immediately", "queries": ["What happens when a material share is removed?", "资料共享被移除后新检索如何处理？"]},
