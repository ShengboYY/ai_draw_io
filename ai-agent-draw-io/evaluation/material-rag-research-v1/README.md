...
Task hydration serializes the frozen equal-RRF fusion of the original and evidence-focused top-80 query
lanes. It records `candidateQueryMode`, `queryRewriteFingerprint`, and `queryFusionFingerprint`. The exporter
