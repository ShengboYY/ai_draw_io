...
`evaluation/auto-memory-context-v3/README.md`，V3 只允许一次盲测且不得用于继续调参。
...
V1.7.2 已在新 development-v2 上选定分数下限加相对分差的有界准入规则，V3 仍须按预注册边界
一次性验收。与此同时随本地真实使用积累非合成样本并比较错误归并，
