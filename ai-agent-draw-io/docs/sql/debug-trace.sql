...
CREATE TABLE IF NOT EXISTS agent_debug_trace_capture (
    ...
    payload_kind       VARCHAR(64) NOT NULL COMMENT 'RUN_INPUT | RUN_OUTPUT | LLM_INPUT | LLM_OUTPUT | TOOL_INPUT | TOOL_OUTPUT',
    ...
    original_length    INT NOT NULL DEFAULT 0 COMMENT '截断前字符数',
