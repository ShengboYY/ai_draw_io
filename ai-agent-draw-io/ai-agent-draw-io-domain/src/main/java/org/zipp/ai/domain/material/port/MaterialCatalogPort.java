...
public interface MaterialCatalogPort {
    ...
    default MaterialCatalogPage findMaterialsForScope(MaterialScopeCatalogQuery query) {
        throw new UnsupportedOperationException("scoped catalog listing is unavailable");
    }
